...
MatStartDate.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MatStartDate, selectors: [["input", "matStartDate", ""]], hostAttrs: ["type", "text", 1, "mat-date-range-input-inner"], hostVars: 8, hostBindings: function MatStartDate_HostBindings(rf, ctx) { if (rf & 1) {
...
MatEndDate.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MatEndDate, selectors: [["input", "matEndDate", ""]], hostAttrs: ["type", "text", 1, "mat-date-range-input-inner"], hostVars: 7, hostBindings: function MatEndDate_HostBindings(rf, ctx) { if (rf & 1) {
...
MatDateRangeInput.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MatDateRangeInput, selectors: [["mat-date-range-input"]], contentQueries: function MatDateRangeInput_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, hostAttrs: [1, "mat-date-range-input"], hostVars: 3, hostBindings: function MatDateRangeInput_HostBindings(rf, ctx) { if (rf & 2) {
